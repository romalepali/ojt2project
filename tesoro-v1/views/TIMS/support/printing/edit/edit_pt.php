<?php
    ...
    $pt_save = "UPDATE printing SET printing='$pt' WHERE id=".$_GET['edit'];
...
//Big Jobs Only
	$query="SELECT * FROM printing WHERE id=".$_GET['edit'];
	...
	<div class="row">
		<div class="col-xl">
			<div class="form-group row">
				...
				<div class="col-12">
					<input class="form-control" type="text" placeholder="Enter Printing" value="<?php echo $row['printing'];?>" name="pt" id="pt" required>
				</div>
			</div>
		</div>
	</div>
