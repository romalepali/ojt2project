...
if (isset($_POST['add_pt_save'])) {
    ...
    $add_query = "INSERT INTO printing (printing,added_by) VALUES ('$pt','$add')";


    $duple_query="SELECT * FROM printing WHERE BINARY (printing='$pt')";
  ...
  <div class="row">
    <div class="col-xl">
      <div class="form-group row">
        ...
        <div class="col-12">
          <input class="form-control" type="text" placeholder="Enter Printing" name="pt" id="pt" required>
        </div>
      </div>
    </div>
  </div>
