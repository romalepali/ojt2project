<?php
	...
	$_SESSION['page']='input_payments.php';

	$count_query="SELECT count(*) AS 'ucount' FROM jobbings_payment";
	$count_result=mysqli_query($conn,$count_query);
?>
<!DOCTYPE html>
<html>
<head>
	<title>Inputs | Payments</title>
		...
		<div id="content">
			<div class="row">
				...
				<?php if(
					...
					<ul id="tabsJustified" class="nav nav-tabs">
						<li class="nav-item">
							<a href="input_payments.php" class="nav-link small text-uppercase active">
								All Payments
						...
						<div id="all_jobs" class="tab-pane fade active show">
							...
							<div class="table-responsive" style="max-height: 70vh;">
								<table class="table table-hover" id="myTable">
									<thead>
										<tr>
											<th onclick="sortTable(0)" class="tableSort">Payment</th>
									...
									<tbody>
									<?php
									$sql_query="SELECT a.*,b.firstname AS 'fn',b.lastname AS 'ln' FROM jobbings_payment a LEFT JOIN users b ON a.added_by=b.id ORDER BY a.payment ASC";
			...
			?>
				<ul id="tabsJustified" class="nav nav-tabs" id="tabs">
					<li class="nav-item">
						<a href="input_payments.php" class="nav-link small text-uppercase">
							All Payment
							<span class="float-right badge badge-pill badge-danger" style="margin-left:10px">
								<?php
                                    if(mysqli_num_rows($count_result)>0)
			...
			<?php
				if(isset($_GET['edit'])){
					include ('payments/edit_payments.php');
				} else if(isset($_GET['add'])){
					include ('payments/add_payments.php');
				} else if(isset($_GET['remove'])){
					include ('payments/remove_payments.php');
				} 
			}
			?>
				</div>
