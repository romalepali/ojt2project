<?php
	...
	$_SESSION['page']='input_status.php';

	$count_query="SELECT count(*) AS 'ucount' FROM jobbings_statuses";
		...
		<div id="content">
			<div class="row">
				...
				<?php if(
					...
					<ul id="tabsJustified" class="nav nav-tabs">
						<li class="nav-item">
							<a href="input_status.php" class="nav-link small text-uppercase active">
								All Status
						...
						<div id="all_jobs" class="tab-pane fade active show">
							...
							<div class="table-responsive" style="max-height: 70vh;">
								<table class="table table-hover" id="myTable">
									...
									<tbody>
									<?php
									$sql_query="SELECT a.*,b.firstname AS 'fn',b.lastname AS 'ln' FROM jobbings_statuses a LEFT JOIN users b ON a.added_by=b.id ORDER BY a.status_name ASC";
			...
			?>
				<ul id="tabsJustified" class="nav nav-tabs" id="tabs">
					<li class="nav-item">
						<a href="input_status.php" class="nav-link small text-uppercase">
							All Status
							<span class="float-right badge badge-pill badge-danger" style="margin-left:10px">
								<?php
                                    if(mysqli_num_rows($count_result)>0)
			...
			<?php
				if(isset($_GET['edit'])){
					include ('status/edit_status.php');
				} else if(isset($_GET['add'])){
					include ('status/add_status.php');
				} else if(isset($_GET['remove'])){
					include ('status/remove_status.php');
				} 
			}
			?>
				</div>
