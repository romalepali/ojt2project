<?php
	...
	$_SESSION['page']='input_printing.php';

	$count_query="SELECT count(*) AS 'ucount' FROM printing";
	$count_result=mysqli_query($conn,$count_query);
?>
<!DOCTYPE html>
<html>
<head>
	<title>Inputs | Printing</title>
		...
		<div id="content">
			<div class="row">
				...
				<?php if(
					...
					<ul id="tabsJustified" class="nav nav-tabs">
						<li class="nav-item">
							<a href="input_printing.php" class="nav-link small text-uppercase active">
								All Printings
						...
						<div id="all_jobs" class="tab-pane fade active show">
							...
							<div class="table-responsive" style="max-height: 70vh;">
								<table class="table table-hover" id="myTable">
									<thead>
										<tr>
											<th onclick="sortTable(0)" class="tableSort">Printing</th>
									...
									<tbody>
									<?php
									$sql_query="SELECT a.*,b.firstname AS 'fn',b.lastname AS 'ln' FROM printing a LEFT JOIN users b ON a.added_by=b.id ORDER BY printing ASC";
									...
									?>
										<tr>
											<td colspan="4" style="text-align: center;">No printings yet!</td>
										</tr>
										<?php
										}
										?>
			...
			?>
				<ul id="tabsJustified" class="nav nav-tabs" id="tabs">
					<li class="nav-item">
						<a href="input_printing.php" class="nav-link small text-uppercase">
							All Printings
							<span class="float-right badge badge-pill badge-danger" style="margin-left:10px">
								<?php
                                    if(mysqli_num_rows($count_result)>0)
			...
			<?php
				if(isset($_GET['edit'])){
					include ('printing/edit_printing.php');
				} else if(isset($_GET['add'])){
					include ('printing/add_printing.php');
				} else if(isset($_GET['remove'])){
					include ('printing/remove_printing.php');
				} 
			}
			?>
				</div>
