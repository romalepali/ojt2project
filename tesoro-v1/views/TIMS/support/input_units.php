<?php
	...
	$_SESSION['page']='input_units.php';

	$count_query="SELECT count(*) AS 'ucount' FROM copies_units";
		...
		<div id="content">
			<div class="row">
				...
				<?php if(
					...
					<ul id="tabsJustified" class="nav nav-tabs">
						<li class="nav-item">
							<a href="input_units.php" class="nav-link small text-uppercase active">
								All Units
						...
						<div id="all_jobs" class="tab-pane fade active show">
							...
							<div class="table-responsive" style="max-height: 70vh;">
								<table class="table table-hover" id="myTable">
									<thead>
										<tr>
											<th onclick="sortTable(0)" class="tableSort">Unit</th>
									...
									<tbody>
									<?php
									$sql_query="SELECT a.*,b.firstname AS 'fn',b.lastname AS 'ln' FROM copies_units a LEFT JOIN users b ON a.added_by=b.id ORDER BY unit ASC";
			...
			?>
				<ul id="tabsJustified" class="nav nav-tabs" id="tabs">
					<li class="nav-item">
						<a href="input_units.php" class="nav-link small text-uppercase">
							All Units
							<span class="float-right badge badge-pill badge-danger" style="margin-left:10px">
								<?php
                                    if(mysqli_num_rows($count_result)>0)
			...
			<?php
				if(isset($_GET['edit'])){
					include ('units/edit_units.php');
				} else if(isset($_GET['add'])){
					include ('units/add_units.php');
				} else if(isset($_GET['remove'])){
					include ('units/remove_units.php');
				} 
			}
			?>
				</div>
