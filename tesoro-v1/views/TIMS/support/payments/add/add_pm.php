...
if (isset($_POST['add_pm_save'])) {
    ...
    $add_query = "INSERT INTO jobbings_payment (payment,added_by) VALUES ('$pm','$add')";

    $duple_query="SELECT * FROM jobbings_payment WHERE BINARY (payment='$pm')";
  ...
  <div class="row">
    <div class="col-xl">
      <div class="form-group row">
        ...
        <div class="col-12">
          <input class="form-control" type="text" placeholder="Enter Payment" name="pm" id="pm" required>
        </div>
      </div>
    </div>
  </div>
