...
if (isset($_POST['add_jt_save'])) {
    ...
    $add_query = "INSERT INTO jobbings_type (job_type,added_by) VALUES ('$jt','$add')";

    $duple_query="SELECT * FROM jobbings_type WHERE BINARY (job_type='$jt')";
  ...
  <div class="row">
    <div class="col-xl">
      <div class="form-group row">
        ...
        <div class="col-12">
          <input class="form-control" type="text" placeholder="Enter Type of Job" name="jt" id="jt" required>
        </div>
      </div>
    </div>
  </div>
