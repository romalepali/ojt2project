<?php
	...
	$_SESSION['page']='input_colors.php';

	$count_query="SELECT count(*) AS 'ucount' FROM printing_colors";
		...
		<div id="content">
			<div class="row">
				...
				<?php if(
					...
					<ul id="tabsJustified" class="nav nav-tabs">
						<li class="nav-item">
							<a href="input_colors.php" class="nav-link small text-uppercase active">
								All Colors
						...
						<div id="all_jobs" class="tab-pane fade active show">
							...
							<div class="table-responsive" style="max-height: 70vh;">
								<table class="table table-hover" id="myTable">
									<thead>
										<tr>
											<th onclick="sortTable(0)" class="tableSort">Color</th>
									...
									<tbody>
									<?php
									$sql_query="SELECT a.*,b.firstname AS 'fn',b.lastname AS 'ln' FROM printing_colors a LEFT JOIN users b ON a.added_by=b.id ORDER BY a.color ASC";
			...
			?>
				<ul id="tabsJustified" class="nav nav-tabs" id="tabs">
					<li class="nav-item">
						<a href="input_colors.php" class="nav-link small text-uppercase">
							All Colors
							<span class="float-right badge badge-pill badge-danger" style="margin-left:10px">
								<?php
                                    if(mysqli_num_rows($count_result)>0)
			...
			<?php
				if(isset($_GET['edit'])){
					include ('colors/edit_colors.php');
				} else if(isset($_GET['add'])){
					include ('colors/add_colors.php');
				} else if(isset($_GET['remove'])){
					include ('colors/remove_colors.php');
				} 
			}
			?>
				</div>
