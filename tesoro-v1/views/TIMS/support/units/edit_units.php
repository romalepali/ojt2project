	...
	if(is_numeric($_GET['edit']) && $_GET['edit']!=0){
		...
		<?php
			...
			<div style="max-height: 75vh; overflow-x: hidden; padding: 20px 10px">
				Sorry, units does not exist! <a class="btn btn-primary" href="<?php echo $_SESSION['page'];?>">Back</a>
			</div>
		<?php
		} 
 	}else {?>
