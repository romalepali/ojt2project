<?php
    ...
    $cl_save = "UPDATE printing_colors SET color='$cl' WHERE id=".$_GET['edit'];
...
//Big Jobs Only
	$query="SELECT color AS 'cl' FROM printing_colors WHERE id=".$_GET['edit'];
	...
	<div class="row">
		<div class="col-xl">
			<div class="form-group row">
				...
				<div class="col-12">
					<input class="form-control" type="text" placeholder="Enter Color" value="<?php echo $row['cl'];?>" name="cl" id="cl" required>
				</div>
			</div>
		</div>
	</div>
