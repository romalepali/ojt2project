...
<body>
			...
			<div class="row">
				...
				<?php if(
					...
					<ul id="tabsJustified" class="nav nav-tabs">
						...
						<li class="nav-item">
							<a href="users_ac.php" class="nav-link small text-uppercase active">
								Active
								<span class="float-right badge badge-pill badge-danger" style="margin-left:10px">
								<?php
						...
						<div id="all_jobs" class="tab-pane fade active show">
							<div class="table-responsive" style="max-height: 70vh;">
								<table class="table table-hover" id="myTable">
									...
									<tbody>
									<?php
									$sql_query="SELECT a.*,b.name FROM users a LEFT JOIN users_privileges b ON a.type=b.id WHERE (a.type!=1 && a.status='Active') ORDER BY a.id";
									...
									?>
										<tr>
											<td colspan="9" style="text-align: center;">No active users yet!</td>
										</tr>
										<?php
										}
										?>
	...
	<script src="js/users_ac_action.js"></script>
