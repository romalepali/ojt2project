<?php
	...
	$_SESSION['page']='input_paper_size.php';

	$count_query="SELECT count(*) AS 'ucount' FROM printing_paper_size";
	$count_result=mysqli_query($conn,$count_query);
?>
<!DOCTYPE html>
<html>
<head>
	<title>Inputs | Paper Size</title>
...
<body>
		...
		<div id="content">
			<div class="row">
				...
				<?php if(
					...
					<ul id="tabsJustified" class="nav nav-tabs">
						<li class="nav-item">
							<a href="input_paper_size.php" class="nav-link small text-uppercase active">
								All Paper Sizes
						...
						<div id="all_jobs" class="tab-pane fade active show">
							...
							<div class="table-responsive" style="max-height: 70vh;">
								<table class="table table-hover" id="myTable">
									<thead>
										<tr>
											<th onclick="sortTable(0)" class="tableSort">Paper Size</th>
									...
									<tbody>
									<?php
									$sql_query="SELECT a.*,b.firstname AS 'fn',b.lastname AS 'ln' FROM printing_paper_size a LEFT JOIN users b ON a.added_by=b.id ORDER BY a.size ASC";
									...
									?>
										<tr>
											<td colspan="4" style="text-align: center;">No paper sizes yet!</td>
										</tr>
										<?php
										}
										?>
			...
			?>
				<ul id="tabsJustified" class="nav nav-tabs" id="tabs">
					<li class="nav-item">
						<a href="input_paper_sized.php" class="nav-link small text-uppercase">
							All Paper Sizes
							<span class="float-right badge badge-pill badge-danger" style="margin-left:10px">
								<?php
                                    if(mysqli_num_rows($count_result)>0)
			...
			<?php
				if(isset($_GET['edit'])){
					include ('paper_size/edit_paper_size.php');
				} else if(isset($_GET['add'])){
					include ('paper_size/add_paper_size.php');
				} else if(isset($_GET['remove'])){
					include ('paper_size/remove_paper_size.php');
				} 
			}
			?>
				</div>
	...
	<script src="js/paper_size.js"></script>
