function edit(id)
{
	swal({
		...
		function(isConfirm){
		if (isConfirm) {
		    window.location.href='all_jobs.php?edit='+id;
		} else {
...
function update(id)
{
	swal({
		...
		function(isConfirm){
		if (isConfirm) {
		    window.location.href='all_jobs.php?update='+id;
		} else {
...
function add(id)
{
	window.location.href='all_jobs.php?add='+id;
}

function more(id)
{
	window.location.href='all_jobs.php?more='+id;
}