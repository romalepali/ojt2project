...
if (isset($_POST['add_big_save'])) {
    ...
    $add = "INSERT INTO jobbings (job_no,job_kind,description,date_received,due_date,agent,customer,artist,current_status,current_note,status_date,added_by,updated_by,cover,pages,initial_copies,copies_unit,payment,date_added) VALUES ('$jon','$koj','$des','$dr','$dd','$agent','$customer','$artist','$status','$notes',NOW(),'$added_by','$updated_by','$cover','$pages','$copies','$units','$payment',NOW())";
...
<form action="<?php echo $_SESSION['page'];?>?add=big" method="POST">
  <div class="row">
    <div class="col-xl">
      ...
      <div class="form-group row">
        ...
        <div class="col-12">
          <select class="custom-select" name="koj" id="koj" required>
            ...
            <?php
              $koj_query="SELECT * FROM jobbings_kinds WHERE type=1 GROUP BY kind_of_job ASC";
