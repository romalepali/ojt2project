		              ...
		              <?php 
		               ...
		               ?>
						...
						function filterTable(event) {
						    ...
						    var display = document.querySelector("#noDisplay");
						    var count = 0;
						...
						document.querySelector('#search').addEventListener('mousemove', filterTable, false);	
								...
								<table class="table table-hover" id="myTable">
									<thead>
										<tr>
											...
											<th onclick="sortTable(6)" class="tableSort">Kind of Job</th>
											<th onclick="sortTable(7)" class="tableSort">Quantity</th>
											<th onclick="sortTable(8)" class="tableSort">Artist</th>
											<th onclick="sortTable(9)" class="tableSort">Pages</th>
											<th onclick="sortTable(10)" class="tableSort">Status</th>
											<th onclick="sortTable(11)" class="tableSort">Due date</th>
											<th onclick="sortTable(12)" class="tableSort">Notes</th>
										</tr>
									</thead>
									<tbody>
