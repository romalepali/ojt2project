			...
			<div class="row">
				<div class="col-md-12">
					...
					<ul id="tabsJustified" class="nav nav-tabs">
						...
						<li class="nav-item"><a href="reports_small_jobs.php" class="nav-link small text-uppercase active"> Small Jobs</a></li>
