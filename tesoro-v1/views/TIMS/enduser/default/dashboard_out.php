<?php  
	...
	$date = date('Y-m-d');
	if(isset($_POST['view'])){		
		$query = "SELECT a.*,b.kind_of_job,c.status_name FROM jobbings a LEFT JOIN jobbings_kinds b  ON a.job_kind=b.id INNER JOIN jobbings_statuses c ON a.current_status = c.id  WHERE a.current_status = 5 ORDER BY a.date_added ASC ";
