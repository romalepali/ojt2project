<?php
	...
	$_SESSION["filter"] = "clients_small_jobs";	
	$_SESSION['page']='clients_small_jobs.php';
...
<body>
			...
			<div class="row">
				<div class="col-md-12">
					...
					<ul id="tabsJustified" class="nav nav-tabs">
						...
						<li class="nav-item"> <a href="clients_small_jobs.php"  class="nav-link small text-uppercase active">Small Jobs</a></li>
						...
						<div id="home1" class="tab-pane fade active show">
							<div class="table-responsive">
								<table class="table table-hover" id="dataTable"><?php 
									$sql_query="SELECT  jobbings.customer FROM jobbings LEFT JOIN jobbings_kinds ON jobbings.job_kind = jobbings_kinds.id WHERE jobbings_kinds.type = 2 ORDER BY jobbings.customer ASC";
										...
										while ($row = mysqli_fetch_array($result_set)){
											...
											if($customer!=$ifExist){ 
												...
												<tbody>
													...
													$query = " SELECT  a.id,a.job_no FROM jobbings a LEFT JOIN jobbings_kinds b ON a.job_kind = b.id WHERE customer = ('$customer') AND type = 2 ORDER BY a.job_no ASC ";
	...
	<script src="js/clients_small.js"></script>
