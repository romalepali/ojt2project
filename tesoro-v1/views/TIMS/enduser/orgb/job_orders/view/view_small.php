<?php
	...
	$query="SELECT a.job_no AS 'jon',a.description AS 'des',a.date_received,a.due_date,a.agent,a.customer,a.artist,a.date_added,a.current_note,a.cover,a.pages,a.initial_copies,b.kind_of_job AS 'koj',c.job_type AS 'jt',c.id AS 'type',d.status_name AS 'sn',e.unit,f.color,g.materials,h.size,i.printing,j.payment FROM jobbings a LEFT JOIN jobbings_kinds b ON a.job_kind=b.id RIGHT JOIN jobbings_type c ON b.type=c.id LEFT JOIN jobbings_statuses d ON a.current_status=d.id LEFT JOIN copies_units e ON a.copies_unit=e.id LEFT JOIN printing_colors f ON a.color=f.id LEFT JOIN printing_materials g ON a.materials=g.id LEFT JOIN printing_paper_size h ON a.size=h.id LEFT JOIN printing i ON a.printing=i.id LEFT JOIN jobbings_payment j ON a.payment=j.id WHERE a.id=".$_GET['view'];
	...
	<div class="row">
		<div class="col-xl">
			<div class="form-group row">
				...
				<div class="col-12">
					<input class="form-control" type="text" value="<?php if($row['agent']!=NULL){echo $row['agent'];}else{echo "N/A";}?>" id="koj" disabled>
				</div>
			</div>
		</div>
	...
	<div class="row">
		<div class="col-xl">
			<div class="form-group row">
				...
				<div class="col-12">
					<input class="form-control" type="text" value="<?php if($row['pages']!=NULL){echo $row['pages'];}else{echo "N/A";}?>" id="text" disabled>
				</div>
			</div>
		</div>
		...
		<div class="col-xl">
			<div class="form-group row">
				...
				<div class="col-12">
					<input class="form-control" type="text" value="<?php if($row['color']!=NULL){echo $row['color'];}else{echo "N/A";}?>" id="color" disabled>
				</div>
			</div>
		</div>
	</div>
	...
	<div class="row">
		<div class="col-xl">
			<div class="form-group row">
				...
				<div class="col-12">
					<input class="form-control" type="text" value="<?php if($row['materials']!=NULL){echo $row['materials'];}else{echo "N/A";}?>" id="materials" disabled>
				</div>
			</div>
		</div>
		...
		<div class="col-xl">
			<div class="form-group row">
				...
				<div class="col-12">
					<input class="form-control" type="text" value="<?php if($row['size']!=NULL){echo $row['size'];}else{echo "N/A";}?>" id="size" disabled>
				</div>
			</div>
		</div>	
	</div>
	...
	<div class="row">
		<div class="col-xl">
			<div class="form-group row">
				...
				<div class="col-12">
					<input class="form-control" type="textl" value="<?php if($row['printing']!=NULL){echo $row['printing'];}else{echo "N/A";}?>" id="printing" disabled>
				</div>
			</div>
		</div>
	...
	<div class="row">
		<div class="col-xl">
			<div class="form-group row">
				...
				<div class="col-12">
					<textarea class="form-control" rows="10" style="resize: none;" id="notes" disabled><?php if($row['current_note']!=NULL){echo $row['current_note'];}else{echo 'N/A';}?></textarea>
				</div>
			</div>
		</div>
	</div>