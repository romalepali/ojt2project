<?php
	...
	$_SESSION['page']='big_jobs_small.php';
...
<body>
		...
		<div id="content">
			<div class="row">
				...
				<?php if(
					...
					<li class="nav-item">
						<a href="big_jobs_small.php" class="nav-link small text-uppercase active">
							Big Jobs (Small)
							<span class="float-right badge badge-pill badge-danger" style="margin-left:10px">
							<?php
					...
					<div id="tabsJustifiedContent" class="tab-content">
						<div id="all_jobs" class="tab-pane fade active show">
							<div>
								<a class="btn btn-secondary" href="javascript: add('big_small')" title="Add New" style="font-size: 12px; float: right; margin: 5px 0px 5px 5px;"><img src="images/new.png" width="12px" style="margin: -3px -3px 0px -3px;"></a>
							</div>
			...
			<?php
				if(isset($_GET['view'])){
            		...
            		include ('job_orders/update_job_orders_big_small.php');
	...
	<script src="js/big_jobs_small_action.js"></script>
</body>
</html>