...
if(isset($_POST['e_save']) && $_POST['e_save']=='true'){
	...
	$update_info = "UPDATE users SET firstname='$fn',middlename='$mn',lastname='$ln',birthdate='$bd',email='$email',username='$un' WHERE id=".$_SESSION['TIMS_id'];
...
<form role="form" method="POST">
	...
	<div class="form-group row">
		...
		<div class="col-lg-10">
			<a href="profile_edit.php" class="btn btn-secondary">Cancel</a>
