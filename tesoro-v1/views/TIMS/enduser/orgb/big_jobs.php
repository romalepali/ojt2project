...
<body>
	...
	<div class="container-fluid">
		<div id="content">
			<div class="row">
				...
				<?php if(
					...
					<ul id="tabsJustified" class="nav nav-tabs" id="tabs">
						...
						<li class="nav-item">
							<a href="big_jobs.php" class="nav-link small text-uppercase active">
								Big Jobs
								<span class="float-right badge badge-pill badge-danger" style="margin-left:10px">
								<?php
					...
					<div id="tabsJustifiedContent" class="tab-content">
						<div id="all_jobs" class="tab-pane fade active show">
							<div>
								<a class="btn btn-secondary" href="javascript: add('big')" title="Add New" style="font-size: 12px; float: right; margin: 5px 0px 5px 5px;"><img src="images/new.png" width="12px" style="margin: -3px -3px 0px -3px;"></a>
							</div>
			...
			<?php
				if(isset($_GET['view'])){
            		include ('job_orders/view_job_orders_big.php');
				} else if(isset($_GET['edit'])){
            		include ('job_orders/edit_job_orders_big.php');
				} else if(isset($_GET['update'])){
            		include ('job_orders/update_job_orders_big.php');
				} else if(isset($_GET['more'])){
            		include ('job_orders/more_info_big.php');
				} else if(isset($_GET['add'])){
					include ('job_orders/add_job_orders_big.php');
				} 
			}
			?>
			</div>
	...
	<script src="js/big_jobs_action.js"></script>
</body>
</html>