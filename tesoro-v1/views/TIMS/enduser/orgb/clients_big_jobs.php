<?php
	...
	$_SESSION['page']='clients_big_jobs.php';
...
<body>
			...
			<div class="row">
				<div class="col-md-12">
					...
					<ul id="tabsJustified" class="nav nav-tabs">
						...
						<li class="nav-item"> <a href="clients_big_jobs.php"  class="nav-link small text-uppercase active">Big Jobs</a></li>
						...
						<div id="home1" class="tab-pane fade active show">
							<div class="table-responsive">
								<table class="table table-hover" id="dataTable"><?php
									...
									$sql_query="SELECT a.id, a.customer FROM jobbings a LEFT JOIN jobbings_kinds b ON a.job_kind = b.id WHERE b.type =1 ORDER BY customer ASC ";
										...
										while ($row = mysqli_fetch_array($result_set)){
											...
											if($customer!=$ifExist){ 
												...
												<tbody>     
													...
													$query = " SELECT a.id, a.job_no FROM jobbings a LEFT JOIN jobbings_kinds b ON a.job_kind = b.id WHERE a.customer = ('$customer') && b.type = 1  ORDER BY a.job_no ASC ";
	...
	<script src="js/clients_big.js"></script>
	<script>
		function myFunction() {
