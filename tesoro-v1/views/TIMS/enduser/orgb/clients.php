<?php
	...
	$_SESSION["filter"] = "clients";
	$_SESSION['page']='clients.php';          
?>
<!DOCTYPE html>
<html>
<head>
	<?php include ('include/head.php');?>
	<title>TIMS | Clients</title>
</head>
<style type="text/css">
	.nav-clients {
			...
			<div class="row">
				<div class="col-md-12">
					...
					<ul id="tabsJustified" class="nav nav-tabs">
						<li class="nav-item"><a href="clients.php" class="nav-link small text-uppercase active">All</a></li>
					...
					<?php 
						include('clients/search_clients.php');
					?>
					</div>
					<div id="tabsJustifiedContent" class="tab-content" style="margin-top: -10px;">
						<div id="home1" class="tab-pane fade active show">
							<div class="table-responsive" style="max-height: 70vh;">						 
								...
								<?php 
								$sql_query = "SELECT a.id, a.customer FROM jobbings a LEFT JOIN jobbings_kinds b ON a.job_kind = b.id WHERE b.type !=2 ORDER BY customer ASC ";
								...
								if(mysqli_num_rows($result_set)>0){
									...
									if($customer!=$ifExist){ 
										...
										?>
											...
											<?php 
											$query = "SELECT a.id, a.job_no FROM jobbings a LEFT JOIN jobbings_kinds b ON a.job_kind = b.id WHERE a.customer = ('$customer') && b.type != 2  ORDER BY a.job_no ASC  ";
											...
											if(mysqli_num_rows($result)>0){
												...
												?>
													<tr data-toggle="collapsing"  class="collapse out budgets <?php echo $counterRow;?>collapsed">
														<td>No Orders</td>
													</tr>
												<?php
											}
