<?php
	if(isset($_POST['set_cr_small_save'])){
		$cub = $_SESSION['user_id'];
		$small_save = "UPDATE jo SET cover_updated_by='$cub',cover_updated_on=NOW()";
...
<form action="<?php echo $_SESSION['page'];?>?set_cr=<?php echo $_GET['set_cr'];?>" method="POST">
	...
	<div style="float: right; padding: 20px 0px">
		...
		<button class="btn btn-primary" type="submit" name="set_cr_small_save">Save Changes</button>
	</div>
</form>