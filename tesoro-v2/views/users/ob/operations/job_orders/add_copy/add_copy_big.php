<?php
	if(isset($_POST['add_copy_big_save'])){
		$ab = $_SESSION['user_id'];
		$job_no = $_GET['add_copy'];
		$copies = $_POST['copies'];
		
		$big_save1 = "INSERT INTO jo_copies (job_no,copies,added_on,added_by";
		$big_save2 = "VALUES ('$job_no','$copies',NOW(),'$ab'";
...
<form action="<?php echo $_SESSION['page'];?>?add_copy=<?php echo $_GET['add_copy'];?>" method="POST">
	...
	<div style="float: right; padding: 20px 0px">
		...
		<button class="btn btn-primary" type="submit" name="add_copy_big_save">Save Changes</button>
	</div>
</form>