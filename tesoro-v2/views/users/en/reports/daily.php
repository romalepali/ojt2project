					...
					if(mysqli_num_rows($result_set)>0){
						while($row=mysqli_fetch_assoc($result_set)){ 
							...
							if($prevHeadMonth!=$headMonth){?>
								<tr height="10px"  >
									<td style="text-align:left; font-size: 13px; color: rgb(170,0,0); background-color: #E0E0E0;  box-shadow: 0px 3px 1px 0px rgba(0,0,0,0.5); " colspan="12"><?php echo $headMonth; ?></td>
								</tr><?php									
							}
							...
							if($typeId!=NULL){?>  
								<tr class="<?php echo $colorCode;?>" id="dataRow"> 
									...
									<td><?php echo $type;?></td>
									<td><?php echo $kind;?></td> 
									<td><?php echo $totalCopies." ".$unit;?></td>
									<td><?php
