					...
					<tr>
						...
						<th>Status<br>
							<select name="status" id="status">
		  						<option selected="true" disabled="disabled">Select</option><?php
								$statusQuery = "SELECT status FROM jos_list ORDER BY status DESC LIMIT 1";
					...
					if(isset($_POST['view'])){
						if(empty($_POST['monStart'])&&empty($_POST['monEnd'])){
							...
							if(empty($_POST['monEnd'])){
								$sql_query="SELECT a.received_on,a.job_kind,a.agent,a.artist,a.job_no as JobNo ,a.customer,a.description,a.pages,a.deadline_on,a.encoded_on,b.firstname,b.lastname,b.type,c.copies FROM jo a LEFT JOIN users_list b ON a.agent=b.id LEFT JOIN jo_copies c ON a.job_no=c.job_no WHERE a.encoded_by=".$_SESSION['user_id']." AND MONTH(a.received_on) = '$m1' ORDER BY a.received_on DESC";
							}else if(empty($_POST['monStart'])){
								$sql_query="SELECT a.received_on,a.job_kind,a.agent,a.artist,a.job_no as JobNo ,a.customer,a.description,a.pages,a.deadline_on,a.encoded_on,b.firstname,b.lastname,b.type,c.copies FROM jo a LEFT JOIN users_list b ON a.agent=b.id LEFT JOIN jo_copies c ON a.job_no=c.job_no WHERE a.encoded_by=".$_SESSION['user_id']." AND MONTH(a.received_on) = '$m2'  ORDER BY a.received_on DESC";
							}else{
								$sql_query="SELECT a.received_on,a.job_kind,a.agent,a.artist,a.job_no as JobNo ,a.customer,a.description,a.pages,a.deadline_on,a.encoded_on,b.firstname,b.lastname,b.type,c.copies FROM jo a LEFT JOIN users_list b ON a.agent=b.id LEFT JOIN jo_copies c ON a.job_no=c.job_no WHERE a.encoded_by=".$_SESSION['user_id']." AND MONTH(a.received_on) >= '$m1' AND MONTH(a.received_on) <= '$m2' ORDER BY a.received_on DESC";
							}
						}
					}else{
						$sql_query="SELECT a.received_on,a.job_kind,a.agent,a.artist,a.job_no as JobNo ,a.customer,a.description,a.pages,a.deadline_on,a.encoded_on,b.firstname,b.lastname,b.type,c.copies FROM jo a LEFT JOIN users_list b ON a.agent=b.id LEFT JOIN jo_copies c ON a.job_no=c.job_no WHERE a.encoded_by=".$_SESSION['user_id']." AND MONTH(a.received_on) = '$mon' ORDER BY a.received_on DESC";
