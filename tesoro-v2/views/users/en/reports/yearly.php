		...
		<div class="table-responsive" >
			<table class="table table-hover" id="myTable">
				...
				<tbody><?php
					...
					$date = date('Y-m-d');
					$year = date('Y');
					$curYear= date('F', mktime(0, 0, 0, $year, 10));
					$deadline = ""; 

					if(isset($_POST['view'])){
						if(empty($_POST['yearStart'])&&empty($_POST['yearEnd'])){
							$sql_query="SELECT a.received_on,a.job_kind,a.agent,a.artist,a.job_no as JobNo ,a.customer,a.description,a.pages,a.deadline_on,a.encoded_on,b.firstname,b.lastname,b.type,c.copies FROM jo a LEFT JOIN users_list b ON a.agent=b.id LEFT JOIN jo_copies c ON a.job_no=c.job_no WHERE a.encoded_by=".$_SESSION['user_id']." AND YEAR(a.received_on) = '$year' ORDER BY a.received_on DESC";?>
							<h3><?php echo $curYear;?></h3><?php
						}else{
							...
							if(empty($_POST['yearEnd'])){
								$sql_query="SELECT a.received_on,a.job_kind,a.agent,a.artist,a.job_no as JobNo ,a.customer,a.description,a.pages,a.deadline_on,a.encoded_on,b.firstname,b.lastname,b.type,c.copies FROM jo a LEFT JOIN users_list b ON a.agent=b.id LEFT JOIN jo_copies c ON a.job_no=c.job_no WHERE a.encoded_by=".$_SESSION['user_id']." AND YEAR(a.received_on) = '$y1' ORDER BY a.received_on DESC";
							}else if(empty($_POST['yearStart'])){
								$sql_query="SELECT a.received_on,a.job_kind,a.agent,a.artist,a.job_no as JobNo ,a.customer,a.description,a.pages,a.deadline_on,a.encoded_on,b.firstname,b.lastname,b.type,c.copies FROM jo a LEFT JOIN users_list b ON a.agent=b.id LEFT JOIN jo_copies c ON a.job_no=c.job_no WHERE a.encoded_by=".$_SESSION['user_id']." AND YEAR(a.received_on) = '$y2'  ORDER BY a.received_on DESC";
							}else{
								$sql_query="SELECT a.received_on,a.job_kind,a.agent,a.artist,a.job_no as JobNo ,a.customer,a.description,a.pages,a.deadline_on,a.encoded_on,b.firstname,b.lastname,b.type,c.copies FROM jo a LEFT JOIN users_list b ON a.agent=b.id LEFT JOIN jo_copies c ON a.job_no=c.job_no WHERE a.encoded_by=".$_SESSION['user_id']." AND YEAR(a.received_on) >= '$y1' AND YEAR(a.received_on) <= '$y2' ORDER BY a.received_on DESC";
							}
						}
					}else{
						$sql_query="SELECT a.received_on,a.job_kind,a.agent,a.artist,a.job_no as JobNo ,a.customer,a.description,a.pages,a.deadline_on,a.encoded_on,b.firstname,b.lastname,b.type,c.copies FROM jo a LEFT JOIN users_list b ON a.agent=b.id LEFT JOIN jo_copies c ON a.job_no=c.job_no WHERE a.encoded_by=".$_SESSION['user_id']." AND YEAR(a.received_on) = '$year' ORDER BY a.received_on DESC";
