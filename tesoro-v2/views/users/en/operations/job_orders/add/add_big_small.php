...
<form action="<?php echo $_SESSION['page'];?>&add=3" method="POST">
	<div class="row">
		<div class="col-xl">
			...
			<div class="form-group row">
				...
				<div class="col-12">
					<select class="custom-select" name="koj" id="koj" required>
						...
						$koj_query="SELECT * FROM jo_kinds WHERE job_type=3 GROUP BY job_kind ASC";
				...
				<div class="col-12">
					<select class="custom-select" name="cr" id="cr" required>
						...
						if(mysqli_num_rows($cr_result)>0){
							while($cr=mysqli_fetch_array($cr_result)){?><option value='<?php echo $cr['id'];?>'><?php echo $cr['lastname'].", ".$cr['firstname']." ".$cr['middlename'];?></option>"<?php
							}
						}else{?>
							Not Available<?php
						}?>
