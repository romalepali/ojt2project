<?php  
	...
	if(isset($_POST['view'])){
		$query = "SELECT a.*,b.job_kind AS 'kind' FROM jo a LEFT JOIN jo_kinds b ON a.job_kind=b.id WHERE DATE(a.received_on) != ('$date') AND MONTH(a.received_on) = ('$month') AND a.encoded_by=".$_SESSION['user_id']." ORDER BY a.encoded_on DESC";
