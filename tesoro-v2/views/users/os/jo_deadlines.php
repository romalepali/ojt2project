<?php 
	...
	if(isset($_POST['view'])){		
		$query = "SELECT a.job_no,a.description,a.deadline_on,b.job_kind FROM jo a LEFT JOIN jo_kinds b ON a.job_kind=b.id WHERE a.artist=".$_SESSION['user_id']." ORDER BY a.deadline_on DESC";
