<?php
	if(is_numeric($_GET['edit']) && $_GET['edit']!=0){
		$test_query="SELECT a.job_no,a.deadline_on,b.job_type FROM jo a INNER JOIN jo_kinds b ON a.job_kind=b.id WHERE a.job_no=".$_GET['edit'];

		$test_result=mysqli_query($conn,$test_query);
		if(mysqli_num_rows($test_result)>0){
	 		$test=mysqli_fetch_array($test_result);?>
			<title>J.O. No.: <?php echo $test['job_no'];?> | Edit Information</title>
	 		<div class="row">
				<div class="col-10">
