<?php
	...
	if(isset($_SESSION['search'])){
		...
		$query="SELECT a.job_no,a.description,a.customer,a.artist,a.pages,a.received_on,a.deadline_on,b.job_type,b.job_kind FROM jo a LEFT JOIN jo_kinds b ON a.job_kind=b.id WHERE";
		$keyCount = 0;
