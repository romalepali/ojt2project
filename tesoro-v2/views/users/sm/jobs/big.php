<?php
	$_SESSION['page']='all_jobs.php?jobs=big';
?>
<title>Job Orders | Big Jobs</title>
<ul id="tabsJustified" class="nav nav-tabs">
	...
	if(mysqli_num_rows($jt_result)>0){
		while($jt=mysqli_fetch_assoc($jt_result)){
			if($jt['id']==1){?>
				<li class="nav-item">
					<a href="all_jobs.php?jobs=big" class="nav-link small text-uppercase active">
...
<div id="tabsJustifiedContent" class="tab-content">
	<div id="all_jobs" class="tab-pane fade active show">
		<div class="table-responsive">
			...
			<tbody><?php
				$jo_query="SELECT a.job_no,a.description,a.customer,a.pages,a.received_on,a.deadline_on,b.job_kind FROM jo a LEFT JOIN jo_kinds b ON a.job_kind=b.id WHERE b.job_type=1 ORDER BY a.encoded_on DESC";
