<?php
	$_SESSION['page']='job_inputs.php?input=printing';
?>
<title>Job Inputs | Printing</title>
<ul id="tabsJustified" class="nav nav-tabs">
	...
	<li class="nav-item">
		<a href="job_inputs.php?input=printing" class="nav-link small text-uppercase active">
			Printing
			<span class="float-right badge badge-pill badge-danger" style="margin-left:10px"><?php
	...
	<div id="all_jobs" class="tab-pane fade active show">
		...
		<div class="table-responsive">
			<table class="table table-hover" id="myTable">
				...
				<tbody><?php
					$sql_query="SELECT a.*,b.firstname AS 'fn',b.lastname AS 'ln' FROM jo_printing a LEFT JOIN users_list b ON a.updated_by=b.id ORDER BY updated_on DESC";
...
<script src="js/system/ji_printing.js"></script>