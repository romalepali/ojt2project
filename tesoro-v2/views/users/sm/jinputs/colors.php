<?php
	$_SESSION['page']='job_inputs.php?input=colors';
?>
<title>Job Inputs | Colors</title>
<ul id="tabsJustified" class="nav nav-tabs">
	<li class="nav-item">
		<a href="job_inputs.php?input=colors" class="nav-link small text-uppercase active">
			Colors
...
<div id="tabsJustifiedContent" class="tab-content">
	<div id="all_jobs" class="tab-pane fade active show">
		<div>
			<button class="btn btn-secondary" onclick="add('true')" style="font-size: 12px; float: right; margin: 5px 0px 5px 5px;">ADD NEW</button>
		</div>
...
<script src="js/system/ji_colors.js"></script>