<?php
	$_SESSION['page']='job_inputs.php?input=payments';
?>
<title>Job Inputs | Payments</title>
<ul id="tabsJustified" class="nav nav-tabs">
	...
	<li class="nav-item">
		<a href="job_inputs.php?input=payments" class="nav-link small text-uppercase active">
			Payments
			<span class="float-right badge badge-pill badge-danger" style="margin-left:10px"><?php
...
<script src="js/system/ji_payments.js"></script>