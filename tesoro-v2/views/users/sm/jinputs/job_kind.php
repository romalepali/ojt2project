<?php
	$_SESSION['page']='job_inputs.php?input=job_kind';
?>
<title>Job Inputs | Job Kind</title>
<ul id="tabsJustified" class="nav nav-tabs">
	...
	<li class="nav-item">
		<a href="job_inputs.php?input=job_kind" class="nav-link small text-uppercase active">
			Job Kind
			<span class="float-right badge badge-pill badge-danger" style="margin-left:10px"><?php
...
<script src="js/system/ji_kind.js"></script>