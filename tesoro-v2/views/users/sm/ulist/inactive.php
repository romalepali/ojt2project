<?php
	$_SESSION['page']='users.php?users=inactive';
?>
<title>System Users | Inactive</title>
<ul id="tabsJustified" class="nav nav-tabs">
	...
	<li class="nav-item">
		<a href="users.php?users=inactive" class="nav-link small text-uppercase active">
			Inactive
			<span class="float-right badge badge-pill badge-danger" style="margin-left:10px"><?php
	...
	<div id="all_jobs" class="tab-pane fade active show">
		<div class="table-responsive">
			<table class="table table-hover" id="myTable">
				...
				<tbody><?php
					$sql_query="SELECT a.*,b.type AS 'utype' FROM users_list a LEFT JOIN users_type b ON a.type=b.id WHERE (a.type!=2 AND a.status='Inactive') ORDER BY a.id";
