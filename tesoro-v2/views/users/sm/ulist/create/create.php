<?php
	if(isset($_POST['signup'])){
		if(isset($_GET['create']) && $_GET['create']!=NULL){
			$type = $_GET['create'];
		}
		...
		if(strcmp($password,$rpassword) != 0){
			...
			<script type="text/javascript">
				swal({
					...
					if (isConfirm) {
						window.location.href='users.php?create=true';
					}
				});
			</script><?php
		}else{
			...
			if($fetched_row2>0){
				...
				if(mysqli_query($conn,$sql_query)){
					...
					<script type="text/javascript">
						swal({
							title: "Success",
							text: "Account successfully created and activated!",
							type: "success",
							confirmButtonClass: "btn-primary",
							confirmButtonText: "OK",
							closeOnConfirm: false
					...
					<script type="text/javascript">
						swal({
							title: "Failed",
							text: "Error occured while creating an account!",
							type: "error",
							confirmButtonClass: "btn-primary",
							confirmButtonText: "OK",
							closeOnConfirm: false
...
<form action="users.php?create=<?php echo $_GET['create'];?>" method="POST">
	<div class="row">
		<div class="col-xl">
