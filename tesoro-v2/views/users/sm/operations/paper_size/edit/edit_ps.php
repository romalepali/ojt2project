<?php
	if (isset($_POST['edit_ps_save'])) {
		...
		$ps_save = "UPDATE jo_size SET size='$ps',updated_by='$edit',updated_on=NOW() WHERE id=".$_GET['edit'];
	...
	$query="SELECT * FROM jo_size WHERE id=".$_GET['edit'];
	...
	<div class="row">
		<div class="col-xl">
			<div class="form-group row">
				...
				<div class="col-12">
					<input class="form-control" type="text" placeholder="Enter Paper Size" value="<?php echo $row['size'];?>" name="ps" id="ps" autofocus required>
				</div>
			</div>
		</div>
	</div>
