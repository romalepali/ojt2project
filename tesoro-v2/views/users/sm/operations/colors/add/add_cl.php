<?php
	if(isset($_POST['add_cl_save'])){
		...
		$add_query = "INSERT INTO jo_colors (color,updated_by,updated_on) VALUES ('$cl','$add',NOW())";
		$duple_query="SELECT * FROM jo_colors WHERE BINARY (color='$cl')";
	...
	<div class="row">
		<div class="col-xl">
			<div class="form-group row">
				...
				<div class="col-12">
					<input class="form-control" type="text" placeholder="Enter Color" name="cl" id="cl" autofocus required>
				</div>
			</div>
		</div>
	</div>
