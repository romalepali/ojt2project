<?php
	if (isset($_POST['add_mt_save'])) {
		...
		$add_query = "INSERT INTO jo_materials (materials,updated_by,updated_on) VALUES ('$mt','$add',NOW())";
		$duple_query="SELECT * FROM jo_materials WHERE BINARY (materials='$mt')";
	...
	<div class="row">
		<div class="col-xl">
			<div class="form-group row">
				...
				<div class="col-12">
					<input class="form-control" type="text" placeholder="Enter Material" name="mt" id="mt" autofocus required>
				</div>
			</div>
		</div>
	</div>
