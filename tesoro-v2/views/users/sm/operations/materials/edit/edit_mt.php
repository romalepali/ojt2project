<?php
	if (isset($_POST['edit_mt_save'])) {
		...
		$mt_save = "UPDATE jo_materials SET materials='$mt',updated_by='$edit',updated_on=NOW() WHERE id=".$_GET['edit'];
	...
	$query="SELECT * FROM jo_materials WHERE id=".$_GET['edit'];
	...
	<div class="row">
		<div class="col-xl">
			<div class="form-group row">
				...
				<div class="col-12">
					<input class="form-control" type="text" placeholder="Enter Materials" value="<?php echo $row['materials'];?>" name="mt" id="mt" autofocus required>
				</div>
			</div>
		</div>
	</div>
